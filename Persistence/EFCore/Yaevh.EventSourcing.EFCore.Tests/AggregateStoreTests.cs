...
{
    [Fact(DisplayName = "00. Basic sanity check")]
    ...
    public async Task CanStoreEvents()
    {
        ...
        // Act
        var aggregate = BuildAndCheckBasicAggregate();
    ...
    public async Task CanLoadEvents()
    {
        ...
        // Act
        var aggregateEvents = await aggregateStore.LoadAsync(aggregateId, CancellationToken.None);

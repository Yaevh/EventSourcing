    ...
    where TAggregateId : notnull
{
    ...
    internal AggregateEvent<TAggregateId> ToAggregateEvent(EventsDbContext<TAggregateId>.EventData source)
    {
    ...
    internal EventsDbContext<TAggregateId>.EventData ToEventData(AggregateEvent<TAggregateId> source)
    {
        var payload = _eventSerializer.Serialize(source.Payload);

        return new EventsDbContext<TAggregateId>.EventData(
            source.Metadata.EventId,
            source.Metadata.DateTime,
